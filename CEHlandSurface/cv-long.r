...
Training = list(Name = "Relevant Training Courses",
        c("An Introduction to Unix for HPC and Parallel processing techniques" = "http://www.intersect.org.au/energy/training",
          "May 2013",
          "eMast/INTERSECT, Macquarie University, Ryde, NSW, Australia",
          ""),

        c("Programming philosophy, code structure and version control" = "http://software-carpentry.org/",
          "Feb 2013",
          "Software Carpentry",
          ""),
...
AdditionalSection = list(ExtendingContact, Qualifications, Employment,
                         Skills, Awards, "New Page", Workshops,
                         Training, ExtraCircular,
                         Referee)
