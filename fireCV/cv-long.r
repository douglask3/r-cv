...
Qualifications = list(Name = "Academic qualification",
        c("PhD Ecology" = "",
          ...
          'Developing and benchmarking LPX, a coupled Dynamic Global Vegetation and fire Model
          (DGVM-fire) to improve the simulation fire and fire-vegetation
          interactions. Using this new version of LPX to simulate
          fire and fire impacts in Australia over the 21<sup>st</sup> century.
          Thesis can be downloaded from <a href="http://douglask3.github.io/docs/thesis.pdf"> http://douglask3.github.io/docs/thesis.pdf </a>'),
...
Employment = list(Name = "Employment History",
        ...
        c("Postdoctoral Research Assistant" = "",
          ...
          'Fire model evaluation and benchmarking for the vegetation-fire model inter-comparison project
           (fireMIP: <a href = "http://douglask3.github.io/firemip.html" target = "_blank"> douglask3.github.io/firemip </a>.
           Simulating present and future fire regimes using a coupled dynamic
           global vegetation model (DGVM) and process-based fire model.'),
        ...
        c("Research Assistant" = "",
          ...
          "Modelling changes in past and future fire dynamics, and its feedback on carbon stocks."),

        c("Research Assistant" = "",
          "Sep 2008-Sep 2010",
          "Department of Geographical Sciences, University of Bristol, UK" = "http://www.bristol.ac.uk/geography/",
          "Developing a coupled DGVM-fire model and applying the model to: test
           the effectiveness of different fire management techniques in current
           and future climates; and simulate paleo vegetation and carbon stocks."),
...
Publications = list(Name = "Publications",
                    ...
                    list("In Prep",
                         ...
                         c("S Hantson, SP Harrison, DI Kelley, ...",
                           "The Fire Modeling Inter-comparison Project (FireMIP): Observational comparisons and model evaluation",
                           "",
                           "",
                           "",
                           "")))
...
Research = list(Name = "Current Research Interests",
                ...
                the interactions between fire, vegetation and climate, and exploring
                how these interactions impact terrestrial ecosystem properties
                such as carbon cycles, composition, productivity and
                ...
                benchmarking. I am also involved in projects that explore plant resource allocation, phenology and drought recovery strategies.
                &nbsp; <br><br>
                ...
                list(
                     c("Development of the LPX coupled Dynamic Vegetation-fire model" = "http://douglask3.github.io/lpx-dynamic-global-vegetation-model.html",
                       ...
                       represent fire and fire-adapted vegetation. Continued development strands include:
                       <li> Improving fire-model performance for forest ecosystems </li>
                       <li> Parametrization of fire carbon emissions and ecosystem carbon stocks </li>
                     ...
                     c("Vegetation model benchmarking and inter-comparison" = "http://douglask3.github.io/vegetation-model-inter-comparison-benchmarking.html",
                       ...
                       " " = "",
                       'I am the main developer and maintainer of a
                       widely used vegetation-model benchmarking system, which
                       qualitatively assesses model performance for a variety of fire, vegetation and land surface processes. Current work includes:
                            <li> Incorporation of additional fire regime observations </li>
...
Skills = list(Name = "Skills",
              Main = "",
              list(
                   c("Fire and Vegetation modelling" = "",
...
AdditionalSection = list(ExtendingContact, Qualifications, Employment,
                         Publications, Conferences, Awards, "New Page", Skills, Research, Workshops,
                         Training, Software, ExtraCircular,
                         Referee)
